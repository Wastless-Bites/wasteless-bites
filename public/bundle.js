...
(() => {
  ...
  var e = {
      448: (e, t, n) => {
        ...
        function Ae(e, t, n, r, l, a, o, u, i) {
          (De = !1), (Ie = null), Me.apply(je, arguments);
        }
        function $e(e) {
          var t = e,
            n = e;
        ...
        function $r(e) {
          if (!e[Ar]) {
            ...
            null === t || t[Ar] || ((t[Ar] = !0), jr("selectionchange", !1, t));
          }
        }
        function Vr(e, t, n, r) {
          switch (Xt(t)) {
        ...
        function Ha(e, t, n, r) {
          var l = e.stateNode;
          (l.props = n), (l.state = e.memoizedState), (l.refs = Ba), Ta(e);
          var a = t.contextType;
          "object" == typeof a && null !== a
            ? (l.context = Ca(a))
        ...
        function Ro(e, t) {
          ...
          if (
            ...
            if (
              ((n.flags |= 2048),
              Bo(9, Fo.bind(null, n, r, l, t), void 0, null),
              null === Li)
            )
              throw Error(a(349));
            0 != (30 & ho) || Oo(n, t, l);
        ...
        function $o(e, t, n, r) {
          ...
          (mo.flags |= e), (l.memoizedState = Bo(1 | t, n, a, r));
        }
        function Vo(e, t) {
          ...
          uu = {
            ...
            useSyncExternalStore: function (e, t, n) {
              ...
              return (
                ...
                (r.flags |= 2048),
                Bo(9, Fo.bind(null, r, o, n, t), void 0, null),
                n
              );
            },
            useId: function () {
          ...
          if (null !== (o = e.memoizedState) && null !== (r = o.dehydrated))
            return (function (e, t, n, r, l, o, u) {
              ...
              if (((i = 0 != (u & e.childLanes)), wu || i)) {
                ...
                return gs(), ju(e, t, u, (r = fu(Error(a(421)))));
              }
              return "$?" === l.data
                ? ((t.flags |= 128),
                  (t.child = e.child),
              ...
              switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
                ...
                case 3:
                  if (
                    ...
                    e.timeoutHandle = rl(Ss.bind(null, e, Ai, Wi), t);
                    break;
                  }
                  Ss(e, Ai, Wi);
                  break;
        ...
        function os(e, t) {
          ...
          return (
            ...
            2 !== (e = vs(e, t)) && ((t = Ai), (Ai = n), null !== t && us(t)),
            e
          );
        }
        function us(e) {
  ...
  (() => {
    ...
    function p(e, t, n) {
      ...
      let a = null;
      for (let e = 0; null == a && e < l.length; ++e) a = x(l[e], _(r));
      return a;
    }
    function h(e, t, n, r) {
      void 0 === t && (t = []),
    ...
    function E(e, t) {
      ...
      return (
        ...
        n
          .filter((e) => !S(e))
          .reduce((e, t) => e + (g.test(t) ? v : "" === t ? b : w), r)
      );
    }
    function x(e, t) {
      let { routesMeta: n } = e,
    ...
    function A(n, r, l) {
      j() || o(!1);
      let { navigator: a } = t.useContext(D),
        { matches: u } = t.useContext(U),
        i = u[u.length - 1],
        s = i ? i.params : {},
        c = (i && i.pathname, i ? i.pathnameBase : "/");
      i && i.route;
      let d,
        h = (j() || o(!1), t.useContext(I).location);
      if (r) {
        var m;
      ...
      let g = d.pathname || "/",
        v = p(n, { pathname: "/" === c ? g : g.slice(c.length) || "/" }),
        y = (function (e, n, r) {
          var l;
          if (
          ...
          if (null != i) {
            ...
            e >= 0 || o(!1), (u = u.slice(0, Math.min(u.length, e + 1)));
          }
          return u.reduceRight((e, l, a) => {
            let o = l.route.id ? (null == i ? void 0 : i[l.route.id]) : null,
              s = null;
            r && (s = l.route.errorElement || V);
            let c = n.concat(u.slice(0, a + 1)),
              f = () => {
                let n;
                return (
                  (n = o
    ...
    function Z(n) {
      ...
      return null == y
        ...
        : t.createElement(
            D.Provider,
            { value: d },
            t.createElement(I.Provider, { children: l, value: y })
          );
    }
    function J(e) {
    ...
    class ee extends t.Component {
      ...
      render() {
        ...
        if (l === K.error && r._error instanceof AbortedDeferredError)
          throw neverSettledPromise;
        if (l === K.error && !t) throw r._error;
        if (l === K.error)
      ...
      return (
        t.Children.forEach(e, (e, l) => {
          ...
          if (e.type === t.Fragment)
            return void r.push.apply(r, te(e.props.children, a));
          e.type !== G && o(!1), e.props.index && e.props.children && o(!1);
          let u = {
          ...
          e.props.children && (u.children = te(e.props.children, a)), r.push(u);
        }),
        r
      );
    }
    function ne(n) {
      let { basename: r, children: u, window: f } = n,
        d = t.useRef();
      var p;
      null == d.current &&
        (d.current =
          (void 0 === (p = { window: f, v5Compat: !0 }) && (p = {}),
          (function (t, n, r, u) {
            void 0 === u && (u = {});
            ...
            let w = {
              ...
              listen(e) {
                ...
                return (
                  f.addEventListener(a, y),
                  (m = e),
                  () => {
                    f.removeEventListener(a, y), (m = null);
                  }
                );
              },
              createHref: (e) => n(f, e),
      ...
      return (
        t.useLayoutEffect(() => h.listen(g), [h]),
        t.createElement(Z, {
          basename: r,
          children: u,
          location: m.location,
    ...
    const re = function () {
        return t.createElement(
          ...
          t.createElement(
            "div",
            { className: "logo" },
            t.createElement("img", { src: "somelogo", alt: "Wasteless Bites" })
          ),
          t.createElement(
            "div",
            { className: "login" },
            t.createElement("a", { href: "#" }, "Login")
          )
        );
      },
      le = function () {
        return t.createElement(
          ...
          t.createElement(
            ...
            t.createElement("a", { href: "/contact" }, "Contact | "),
            t.createElement("a", { href: "/aboutus" }, "About Us | "),
            t.createElement(
              "a",
              { href: "#" },
              t.createElement("i", { class: "fa-brands fa-instagram" })
            ),
            t.createElement(
              "a",
              { href: "#" },
              t.createElement("i", { class: "fa-brands fa-facebook" })
            ),
            t.createElement(
              "a",
              { href: "#" },
              t.createElement("i", { class: "fa-brands fa-twitter" })
            ),
            t.createElement(
              "a",
              { href: "#" },
              t.createElement("i", { class: "fa-brands fa-linkedin" })
            )
          )
        );
      },
      ...
      oe = function () {
        return t.createElement(
          t.Fragment,
          null,
          t.createElement("h1", null, "Contact Us"),
          t.createElement(
            "p",
            null,
          ...
          t.createElement(
            "form",
            null,
            t.createElement("label", { htmlFor: "name" }, "Name:"),
            ...
            t.createElement("label", { htmlFor: "email" }, "Email:"),
            t.createElement("input", {
              type: "email",
              id: "email",
              name: "email",
            ...
            t.createElement("label", { htmlFor: "message" }, "Message:"),
      ...
      ue = function () {
        return t.createElement(
          ...
          t.createElement(
            "p",
            null,
            "Food waste is an ever-increasing problem that contributes significantly to environmental degradation and greenhouse gas emissions. Restaurants are one of the main contributors to this problem, which is why we are encouraging them to take a proactive approach. One solution is to introduce a special hour or end-of-day call to offer a reduced-price meal or hand out surplus food for free. This approach can help reduce food waste and promote the restaurant's image as a socially responsible and eco-friendly business. It also raises awareness among customers about the issue of food waste and promotes the idea of reusing and recycling surplus food supplies. By taking such steps, restaurants can make a significant contribution to reducing food waste while also promoting their business and attracting customers who value social and environmental responsibility."
          ),
          t.createElement(le, null)
        );
      },
      ie = function () {
        return t.createElement(
          J,
          null,
          t.createElement(G, { path: "/", element: t.createElement(ae, null) }),
          t.createElement(G, {
            path: "/contact",
      ...
      se = function () {
        return t.createElement("div", null, t.createElement(ie, null));
      };
    (0, r.s)(document.getElementById("app")).render(
      t.createElement(ne, null, t.createElement(se, null))
    );
  })();
})();
