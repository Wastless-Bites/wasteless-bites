                ...
                <section>
                    <div className="individual-box">
                        ...
                        <p className="section-two-box-text">
                            ...
                            food! Lets help you and help others reduce waste and
            ...
            <div className="home-section-three">
                ...
                <div className="section-three-right-container">
                    ...
                    <p className="section-three-text">
                        ...
                        repurposed, reused, or upcycled instead of ending up in
                        landfills. We strive to make the most of every resource,
                        including diverting waste towards animal food and other
